...
video_input=r"C:\Users\a5566\OneDrive\Desktop\realsense_record\20230314_150445.bag"
...
#---------------------------------mediapipe end-------------------------------------------------
        ...
        pose_skeleton_list = get_skeleton_pixel(pose_skeleton,input_image_resolusion_weight,input_image_resolusion_height,0)
        ...
        for idx,pixel in pose_skeleton_list:
            ...
            print ("index: " + idx + ' pose_coordinate(m): ' , camera_coordinate)
        ...
        for hand_type,idx,pixel in hands_skeleton_list:
            ...
            dis, camera_coordinate = get_3d_camera_coordinate(pixel, aligned_depth_frame, depth_intrin)
            print ("hand_type(mirrored): "+hand_type+" index: " + idx + ' hand_coordinate(m): ' , camera_coordinate) # Handedness is determined assuming the input image is mirrored in mediapipe
